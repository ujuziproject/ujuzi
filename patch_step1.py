...
target = """    <div className="animate-in slide-in-from-right-4 duration-500">
      <div className="mb-10 text-center">
        <h2 className="text-3xl font-bold tracking-tight text-ink mb-3 font-display">Create an account</h2>
        <p className="text-slate-500">Join uJuzi to get started on your personalized learning journey.</p>
      </div>
